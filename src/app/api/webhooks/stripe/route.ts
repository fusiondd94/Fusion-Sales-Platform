...
export async function POST(request: Request) {
  ...
  if (event.type === "checkout.session.completed") {
    ...
    console.info("Create Fusion client portal, CRM deal, and onboarding tasks", { customer: session.customer, subscription: session.subscription, metadata: session.metadata });
  }
