...
export const demoClients: ClientRecord[] = [
  {
    ...
    recommendation: {
      ...
      rationale: ["Lead capture and professional email are required.", "Managed hosting keeps the client out of technical work."],
      inclusions: ["8-page conversion site", "CRM-ready lead capture", "Managed hosting", "Security monitoring"],
      urgencyMessage: "Standard onboarding cadence recommended.",
      salesAngle: "Start with the complete foundation so the business is not paying twice later."
    },
